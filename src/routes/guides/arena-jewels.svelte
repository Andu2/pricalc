...
<p>If the season were to reset and you had achieved a maximum rank of <input type="number" bind:value={currentRankAtReset} min=1 max=15001 /> <br />
	you would miss out on <strong>{missOutJewels}</strong> <img class="inline-icon" src="images/item/icon_icon_item_91001.png" /> jewels.</p>
