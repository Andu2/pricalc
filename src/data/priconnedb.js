//import unit_enemy_data from "@src/data/unit_enemy_data.json";
//import enemy_parameter from "@src/data/enemy_parameter.json";
import equipment_data from "@src/data/equipment_data.json";
import equipment_enhance_rate from "@src/data/equipment_enhance_rate.json";
import unit_attack_pattern from "@src/data/unit_attack_pattern.json";
import unit_data from "@src/data/unit_data.json";
import unit_promotion from "@src/data/unit_promotion.json";
import unit_promotion_status from "@src/data/unit_promotion_status.json";
import unit_rarity from "@src/data/unit_rarity.json";
import unit_skill_data from "@src/data/unit_skill_data.json";
import skill_data from "@src/data/skill_data.json";
import skill_action from "@src/data/skill_action.json";
import chara_story_status from "@src/data/chara_story_status.json";
import story_detail from "@src/data/story_detail.json";
import unit_status_coefficient from "@src/data/unit_status_coefficient.json";
